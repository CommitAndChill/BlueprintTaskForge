...
protected:
     ...
     * to that task's @TasksToDeactivateOnDeactivate array,
...
public:
    // Editor Properties - Display Options
    UPROPERTY(EditDefaultsOnly, Category = "DisplayOptions", meta = (AllowPrivateAccess = "true"))
    FName Category = NAME_None;

    UPROPERTY(EditDefaultsOnly, Category = "DisplayOptions", meta = (MultiLine = true, AllowPrivateAccess = "true"))
    FName Tooltip = NAME_None;

    UPROPERTY(EditDefaultsOnly, Category = "DisplayOptions", meta = (AllowPrivateAccess = "true"))
    FName MenuDisplayName = NAME_None;

    // Editor Properties - Decorator
    UPROPERTY(Category = "Decorator", EditDefaultsOnly, meta = (AllowPrivateAccess = "true"))
    TSubclassOf<UBtf_NodeDecorator> Decorator = nullptr;

    // Editor Properties - Expose Options (Visible)
    UPROPERTY(VisibleDefaultsOnly, Category = "ExposeOptions", meta = (AllowPrivateAccess = "true"))
    ...
    // Editor Properties - Expose Options (Editable)
    UPROPERTY(EditDefaultsOnly, Category = "ExposeOptions", meta = (AllowPrivateAccess = "true"))
    ...
    // Editor Properties - Developer Settings
    ...
    UPROPERTY(EditDefaultsOnly, Category = "Developer Settings", meta = (AllowPrivateAccess = "true"))
    TArray<TSoftClassPtr<UObject>> ClassLimitations;

    // Editor Delegates
    FOnPostPropertyChanged OnPostPropertyChanged;

    // Editor Property Getters
    BFT_PROPERTY_GET(AllDelegates)
    BFT_PROPERTY_GET(AllFunctions)
    BFT_PROPERTY_GET(AllFunctionsExec)
    BFT_PROPERTY_GET(AllParam)
    BFT_PROPERTY_GET(SpawnParam)
    BFT_PROPERTY_GET(AutoCallFunction)
    BFT_PROPERTY_GET(ExecFunction)
    BFT_PROPERTY_GET(InDelegate)
    BFT_PROPERTY_GET(OutDelegate)
    BFT_PROPERTY_GET(ClassLimitations)
    BFT_PROPERTY_GET(Category)
    BFT_PROPERTY_GET(Tooltip)
    BFT_PROPERTY_GET(MenuDisplayName)
